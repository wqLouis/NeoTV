...
NeoTV 是一个基于 [LibreTV App](https://github.com/rev1si0n/LibreTV) 的免费开源在线视频搜索与观看平台，旨在提供简洁、高效、无广告的观影体验。基于 [Tauri 2.0](https://tauri.app/) 框架开发，实现了对 Windows, macOS, Linux, 以及 Android 的原生支持。
